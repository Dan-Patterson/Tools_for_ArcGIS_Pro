...
from npgeom.fc_geo_io import (_make_nulls_, array_ift, getSR, fc_shapes,
                              fc_data, fc_geometry, poly2array)
...
__all__ = [
    ...
    '_pnts_on_line_', '_polys_to_unique_pnts_',
    '_poly_segments_',
    '_simplify_lines_'
    ]
