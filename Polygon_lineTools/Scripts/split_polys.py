...
def _demo():
    ...
    s_axis = 'X'
    shp_fld, oid_fld, shp_type, SR = fc_info(in_fc)
    out_polys = do_work(in_fc, out_fc, s_type, s_fac, s_axis)
    return out_polys
